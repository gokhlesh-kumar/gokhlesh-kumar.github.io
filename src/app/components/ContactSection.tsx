...
export function ContactSection() {
  return (
    <section id="contact" className="relative py-24 px-4 sm:px-6 overflow-x-hidden">
      {/* Background Blob */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] rounded-full blur-3xl opacity-30 max-w-[100vw]" style={{ background: 'var(--blob-teal)' }} />
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        >
          <h2 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold mb-6" style={{ color: 'var(--text-primary)' }}>
            Got an idea?
          </h2>
          <p className="text-lg md:text-xl lg:text-2xl mb-4" style={{ color: 'var(--text-primary)' }}>
            Let's turn it into a{' '}
            <span className="gradient-text">fast, beautiful mobile experience</span>.
          </p>
        ...
        >
          <p className="text-lg mb-4" style={{ color: 'var(--text-secondary)' }}>
            Open to exciting opportunities in mobile development, full-stack engineering, and real-time systems.
          </p>
          <p className="text-sm" style={{ color: 'var(--text-muted)' }}>
            Preferred tech stack: React Native • TypeScript • Firebase • Node.js • Real-time Architecture
          </p>
        </motion.div>
